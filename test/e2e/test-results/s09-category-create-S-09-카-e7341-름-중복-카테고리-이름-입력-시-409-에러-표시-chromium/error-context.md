...
- Name: s09-category-create.spec.ts >> S-09: 카테고리 추가 >> 대안 흐름: 중복 카테고리 이름 입력 시 409 에러 표시
- Location: s09-category-create.spec.ts:57:7
...
Call log:
  - waiting for getByPlaceholder(/카테고리|category/i).first()
