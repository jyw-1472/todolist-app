...
- Name: s06-todo-delete.spec.ts >> S-06: 할일 삭제 >> 대안 흐름: 확인 다이얼로그에서 취소 클릭 시 삭제되지 않음
- Location: s06-todo-delete.spec.ts:83:7
...
Locator: locator('text=취소 테스트 할일')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=취소 테스트 할일')
