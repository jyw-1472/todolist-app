...
- Name: s09-category-create.spec.ts >> S-09: 카테고리 추가 >> 대안 흐름: 카테고리 이름 미입력 시 에러
- Location: s09-category-create.spec.ts:48:7
...
Call log:
  - waiting for getByRole('button', { name: /추가|add/i })
