...
- Name: s04-todo-create.spec.ts >> S-04: 할일 등록 >> 기본 흐름: 제목·카테고리 입력 후 할일 등록 성공
- Location: s04-todo-create.spec.ts:41:7
...
Locator: locator('text=팀 미팅 자료 준비')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=팀 미팅 자료 준비')
...
```ts
  ...
  3   | /**
  4   |  * S-04: 할일 등록 시나리오
  5   |  * UC-04 / POST /api/todos
  6   |  */
  7   | 
  8   | const TS = Date.now()
  9   | const USER = {
  10  |   email: `test_s04_${TS}@example.com`,
